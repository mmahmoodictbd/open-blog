...
image:https://travis-ci.org/mmahmoodictbd/open-blog.svg?branch=master["Build Status", link="https://travis-ci.org/mmahmoodictbd/open-blog"]
image:https://ci.appveyor.com/api/projects/status/pvt16qsbnb4atemd?svg=true["Appveyor Status", link="https://ci.appveyor.com/project/mmahmoodictbd/open-blog"]
image:https://codecov.io/gh/mmahmoodictbd/open-blog/branch/master/graph/badge.svg["Code Coverage", link="https://codecov.io/gh/mmahmoodictbd/open-blog"]
...
image:https://sonarcloud.io/api/project_badges/measure?project=com.unloadbrain.openblog&metric=alert_status["Quality Gate", link="https://sonarcloud.io/dashboard?id=com.unloadbrain.openblog"]
image:https://sonarcloud.io/api/project_badges/measure?project=com.unloadbrain.openblog&metric=bugs["Bugs", link="https://sonarcloud.io/dashboard?id=com.unloadbrain.openblog"]
image:https://sonarcloud.io/api/project_badges/measure?project=com.unloadbrain.openblog&metric=code_smells["Code smells", link="https://sonarcloud.io/dashboard?id=com.unloadbrain.openblog"]
